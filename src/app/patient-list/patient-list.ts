...
export class PatientListComponent implements OnInit {
  ...
  private loadMockPatients(): void {
    this.patients = [
      ...
      {
        id: '6',
        personalData: { idCard: '44332211', firstName: 'Ana', lastName: 'Martínez', birthDate: '1992-09-18', age: 33, address: '987 Cedar Ln', phone: '+4433221100', isOrthodontic: false },
        insuranceInfo: { hasInsurance: true, insuranceName: 'United Health', affiliateNumber: 'UH-004' },
        dentalRecord: { pathologies: '', allergies: '', medication: '' }
      },
      {
        id: '7',
        personalData: { idCard: '66778899', firstName: 'Michael', lastName: 'Brown', birthDate: '1988-11-30', age: 37, address: '147 Birch Way', phone: '+6677889900', isOrthodontic: true },
        insuranceInfo: { hasInsurance: false, insuranceName: '', affiliateNumber: '' },
        dentalRecord: { pathologies: '', allergies: '', medication: '' }
      },
      {
        id: '8',
        personalData: { idCard: '33445566', firstName: 'Laura', lastName: 'Davis', birthDate: '1975-04-05', age: 50, address: '258 Spruce Ct', phone: '+3344556677', isOrthodontic: false },
        insuranceInfo: { hasInsurance: true, insuranceName: 'Kaiser', affiliateNumber: 'KS-005' },
        dentalRecord: { pathologies: '', allergies: '', medication: '' }
      },
      {
        id: '9',
        personalData: { idCard: '22114433', firstName: 'David', lastName: 'Wilson', birthDate: '1998-02-14', age: 27, address: '369 Willow Blvd', phone: '+2211443355', isOrthodontic: false },
        insuranceInfo: { hasInsurance: true, insuranceName: 'Blue Cross', affiliateNumber: 'BC-006' },
        dentalRecord: { pathologies: '', allergies: '', medication: '' }
      },
      {
        id: '10',
        personalData: { idCard: '77889900', firstName: 'Sofia', lastName: 'Anderson', birthDate: '1993-06-22', age: 32, address: '741 Ash St', phone: '+7788990011', isOrthodontic: true },
        insuranceInfo: { hasInsurance: false, insuranceName: '', affiliateNumber: '' },
        dentalRecord: { pathologies: '', allergies: '', medication: '' }
      },
    ];
  ...
  applyFilters(): void {
    this.filteredPatients = this.patients.filter(patient => {
      ...
      const idCardMatch = this.filters.idCard === '' || 
        patient.personalData.idCard === this.filters.idCard;
      
      // Affiliate Number filter: strict equality (exact match)
      const affiliateMatch = this.filters.affiliateNumber === '' || 
